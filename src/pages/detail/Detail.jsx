...
import { __addComment, __deleteComment, __getCommentById } from '../../redux/modules/commentSlice'
...
const Detail = () => {
  ...
  return (
    ...
    <BodyContainer style={{flexDirection : "column"}}>
        ...
        <StComment>
            <StComInput onChange={commentChange} value={comment.content} placeholder='댓글을 입력해주세요'/>
